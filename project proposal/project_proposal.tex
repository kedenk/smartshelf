...
\subsection{Smart phone app for controll}
To be written 
\section{Approach}
...
The amount of items in one drawer is determined with the weight. 
The overall weight of all items in one drawer is divided by the stored weight of one item. 
With this technique the Smart Shelf can always display the current amount of a specific item. 
